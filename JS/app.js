...
const categoriesItem = item => {
    ...
    result.forEach(newsCard => {
        ...
        <p class="card-text">
        ${newsCard.details.slice(0, 450)}<a href="" class="read-more" data-bs-toggle="modal" data-bs-target="#staticBackdrop"> Read More</a>
        </p>
        ...
        <a href="" class="read-more btn btn-danger" data-bs-toggle="modal" data-bs-target="#exampleModal_${newsCard._id}">Read More <i class="fa-solid fa-arrow-right-long"></i></a>
         </div>
        </div>
        </div>
        </div>
